...
export const Definitions = {
  ...
  terminal_monitor: keybind("<leader>v", "Open terminal session monitor"),
  terminal_monitor_next: keybind("down,j", "Select next terminal session"),
  terminal_monitor_previous: keybind("up,k", "Select previous terminal session"),
  terminal_monitor_close: keybind("x", "Close selected terminal session"),
  terminal_monitor_input: keybind("i", "Send input to selected terminal session"),
  terminal_monitor_refresh: keybind("r", "Refresh terminal session list"),
  terminal_monitor_agent: keybind("a", "Filter terminal sessions by agent"),
  terminal_monitor_back: keybind("escape,q", "Return from terminal session monitor"),
...
export const CommandMap = {
  ...
  terminal_monitor_next: "terminal.monitor.next",
  terminal_monitor_previous: "terminal.monitor.previous",
  terminal_monitor_close: "terminal.monitor.close",
  terminal_monitor_input: "terminal.monitor.input",
  terminal_monitor_refresh: "terminal.monitor.refresh",
  terminal_monitor_agent: "terminal.monitor.agent",
  terminal_monitor_back: "terminal.monitor.back",
